...
class Analytics
{
     ...
     * @param string      $plugin_basename basename of plugin.
     * @param string      $plugin_url      url of plugin.
     * 
     * @author CyberChimps
     * @since  1.0.0
     */
    ...
    private function _register_account_hooks() 
    {
        ...
        if (($this->is_theme() && self::is_themes_page() ||($this->is_plugin() && self::is_plugins_page()))) {
