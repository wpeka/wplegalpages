						...
						<c-card>
							<c-card-body>
								...
								<c-row class="wplegalpages-label-row">
									...
									<c-col class="col-sm-6">
										<label><?php esc_attr_e( 'DBA/Trading Name', 'wplegalpages' ); ?></label>
									</c-col>
								</c-row>
								<c-row>
									<c-col class="col-sm-6">
									...
									<c-col class="col-sm-6">
										<c-input type="text" name="lp-trading-name" placeholder=" DBA/Trading Name" value="<?php echo ! empty( $lp_general['trading'] ) ? esc_attr( $lp_general['trading'] ) : ''; ?>"></c-input>
									</c-col>
								</c-row>
