				...
				<div class="wplegalpages-form-modal-dialog">
					...
					<div class="wplegalpages-form-modal-content">
						...
						<div class="wplegalpages-form-modal-input-group">
							...
							<div class="wplegalpages-form-modal-inputs">
								<!-- <c-textarea id="wplegalpages-lp-form-custom-css" type="text" name="lp-footer-custom-css" v-model="footer_custom_css"></c-textarea>
								<tinymce id="wplegalpages-lp-form-custom-css" :init="tinymceInit"/> -->
								<div id="wplegal-pages-form-css-editor">
								<vue-editor id="wplegalpages-lp-footer-custom-css" :editor-toolbar="customToolbar" v-model="footer_custom_css"></vue-editor>
								</div>
						...
						<!-- <tinymce :init="tinyInit" :plugins="tinyPlugins" :toolbar="tinyToolbar"></tinymce> -->
