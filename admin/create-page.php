...
<div id="wplegal-mascot-app"></div>
	...
	if ( ! $disable_settings_warning ) {
		...
		<div id="wplegalpages_settings_warning" class="notice notice-warning is-dismissible wplegalpages_settings_warning">
			<div>
				<p>Please make sure the website information is correct at the <a href="<?php echo esc_url_raw( admin_url() . 'admin.php?page=legal-pages#settings' ); ?>">Settings page</a> before you create a legal page.</p>
			</div> 
			<div>
