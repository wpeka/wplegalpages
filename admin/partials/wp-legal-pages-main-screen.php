		...
		<div class="wplp-compliance-main-wrapper">
			...
			<div class="wp-legalpages-admin-fixed-banner">
					...
					<div class="wp-legalpages-admin-help-and-support">
						...
						<div class="wp-legalpages-new-dashboard-btn"><a href="<?php echo esc_url( 'https://app.wplegalpages.com/app/' ); ?>" target="_blank"><?php esc_html_e( 'Try New Dashboard', 'wplegalpages' ); ?><span class="wplegalpages-admin-new-dashboard-btn-beta-span">BETA</span></a></div>
						<?php endif; ?>
					...
					<div class="wp-legalpages-admin-tabs">
						...
						<?php 
							if ($is_gdpr_active) {
								...
								if($gdpr_version >= '3.7.0') { ?>
									<a data-redirect-url="admin.php?page=wplp-dashboard" class="wp-legalpages-admin-tab-link dashboard-tab wp-legalpages-admin-tab wp-legalpages-admin-wplp-dashboard-tab">
						...
						if ( $if_terms_are_accepted ) { ?>
							...
							<?php if ($is_gdpr_active) {
								...
								<a data-redirect-url="admin.php?page=wplp-dashboard#help-page" class="wp-legalpages-admin-tab wp-legalpages-admin-help-tab wp-legalpages-admin-tab-link">
									<div class="wplp-admin-tab-link-content">
										<div class="wplp-admin-tab-link-left">
											<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
