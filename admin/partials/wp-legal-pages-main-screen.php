		...
		<div class="wplp-compliance-main-wrapper">
			...
			<div class="wp-legalpages-admin-fixed-banner">
					...
					<div class="wp-legalpages-admin-help-and-support">
						<div class="wp-legalpages-new-dashboard-btn"><a href="<?php echo esc_url( 'https://appstaging.wplegalpages.com/app/' ); ?>"><?php esc_html_e( 'Try New Dashboard', 'wplegalpages' ); ?></a></div>
