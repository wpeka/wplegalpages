                  ...
                  <main class="wplegalpages-help-container">
                    ...
                    <section class="wplegalpages-help-cards">
                      <div class="wplegalpages-help-card">
                        ...
                        <a href="<?php echo esc_url( 'https://wplegalpages.com/docs/wp-cookie-consent/', 'wplegalpages' ); ?>" target="_blank"><?php esc_html_e( "Read Documentation.", 'wplegalpages' ); ?><img class="gdpr-other-plugin-arrow" src="<?php echo esc_url( WPL_LITE_PLUGIN_URL . 'admin/js/vue/images/blue_right_arrow.svg' ); ?>"></a>
                      </div>
                      ...
                      <div class="wplegalpages-help-card">
                        ...
                        <a href="<?php echo esc_url( 'https://wplegalpages.com/docs/wp-cookie-consent/video-guides/video-resources/','wplegalpages' ); ?>" target="_blank"><?php esc_html_e( "Watch Now.", 'wplegalpages' ); ?><img class="gdpr-other-plugin-arrow" src="<?php echo esc_url( WPL_LITE_PLUGIN_URL . 'admin/js/vue/images/blue_right_arrow.svg' ); ?>"></a>
                      </div>
                      ...
                      <div class="wplegalpages-help-card">
                        ...
                        <a href="<?php echo esc_url( 'https://wplegalpages.com/contact-us/', 'wplegalpages' ); ?>" target="_blank"><?php esc_html_e( "Request Now.", 'wplegalpages' ); ?><img class="gdpr-other-plugin-arrow" src="<?php echo esc_url( WPL_LITE_PLUGIN_URL . 'admin/js/vue/images/blue_right_arrow.svg' ); ?>"></a>
                      </div>
                    </section>
