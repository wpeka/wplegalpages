                  ...
                  <main class="wplegalpages-help-container">
                    ...
                    <section class="wplegalpages-help-cards">
                      <div class="wplegalpages-help-card">
                        ...
                        <a href="<?php echo esc_url( 'https://wplegalpages.com/docs/wplp-docs/', 'wplegalpages' ); ?>" target="_blank"><?php esc_html_e( 'Read Documentation.', 'wplegalpages' ); ?><img class="gdpr-other-plugin-arrow" src="<?php echo esc_url( WPL_LITE_PLUGIN_URL . 'admin/js/vue/images/blue_right_arrow.svg' ); ?>"></a>
                      </div>
