	...
	class WP_Legal_Pages_Admin
	{
			...
			<table>
				<tr>
					<?php if ('on' !== $legal_check_status) { ?>
						<td valign="middle" width="10%" align="center"> <input type="checkbox" name="legal_check" id="legal_check">
						</td>
						<td width="90%">
					...
					<?php } else { ?>
						<td valign="middle" width="10%" align="center"> <input type="checkbox" checked name="legal_check"
								id="legal_check"> </td>
						<td width="90%">
		...
		public function gdpr_cookie_consent_install_activate_screen()
		{
			...
			<div class="gdpr-install-activate-screen">
				<img id="gdpr-install-activate-img"
					src="<?php echo esc_url(WPL_LITE_PLUGIN_URL) . 'admin/images/cookie-consent-install-banner.jpg'; ?>"
					alt="WP Cookie Consent Logo">
				<div class="lp-popup-container">

					<p class="lp-plugin-install-activation-text">
						<?php esc_html_e('WP Cookie Consent is currently inactive. Please install and activate the plugin to display the cookie banner and collect user consent.', 'wplegalpages'); ?>
					</p>
					<?php
				...
				array(
					...
					'quick_link' => array(
						'help_center' => array(
							...
							'link' => 'https://wplegalpages.com/docs/wp-legal-pages/',
						...
						'video_guides' => array(
							...
							'link' => 'https://wplegalpages.com/docs/wp-legal-pages/video-guides/video-guides/',
						...
						'faq_answers' => array(
							...
							'link' => 'https://wplegalpages.com/docs/wp-legal-pages/faqs/',
						...
						'feedback' => array(
							...
							'link' => 'https://wplegalpages.com/contact-us/',
							'link_name' => __('Find Out', 'wplegalpages'),
			...
			<div id="posttype-<?php echo esc_attr($post_type_name); ?>" class="posttypediv">
				<ul id="posttype-<?php echo esc_attr($post_type_name); ?>-tabs" class="posttype-tabs add-menu-item-tabs">
					<li <?php echo ('most-recent' === $current_tab ? ' class="tabs"' : ''); ?>>
						<a class="nav-tab-link" data-type="tabs-panel-posttype-<?php echo esc_attr($post_type_name); ?>-most-recent"
							href="<?php echo esc_url($most_recent_url); ?>#tabs-panel-posttype-<?php echo esc_attr($post_type_name); ?>-most-recent">
							<?php esc_attr_e('Most Recent', 'wplegalpages'); ?>
						</a>
					</li>
					<li <?php echo ('all' === $current_tab ? ' class="tabs"' : ''); ?>>
						<a class="nav-tab-link" data-type="<?php echo esc_attr($post_type_name); ?>-all"
							href="<?php echo esc_url($view_all_url); ?>#<?php echo esc_attr($post_type_name); ?>-all">
					...
					<li <?php echo ('search' === $current_tab ? ' class="tabs"' : ''); ?>>
						<a class="nav-tab-link" data-type="tabs-panel-posttype-<?php echo esc_attr($post_type_name); ?>-search"
							href="<?php echo esc_url($search_url); ?>#tabs-panel-posttype-<?php echo esc_attr($post_type_name); ?>-search">
							<?php esc_attr_e('Search', 'wplegalpages'); ?>
						</a>
					</li>
				</ul><!-- .posttype-tabs -->

				<div id="tabs-panel-posttype-<?php echo esc_attr($post_type_name); ?>-most-recent"
					class="tabs-panel <?php echo ('most-recent' === $current_tab ? 'tabs-panel-active' : 'tabs-panel-inactive'); ?>"
					role="region" aria-label="<?php esc_attr_e('Most Recent', 'wplegalpages'); ?>" tabindex="0">
				...
				<div class="tabs-panel <?php echo ('search' === $current_tab ? 'tabs-panel-active' : 'tabs-panel-inactive'); ?>"
					id="tabs-panel-posttype-<?php echo esc_attr($post_type_name); ?>-search" role="region"
					aria-label="<?php echo esc_attr($post_type_name); ?>" tabindex="0">
					<?php
					...
					<p class="quick-search-wrap">
						<label for="quick-search-posttype-<?php echo esc_attr($post_type_name); ?>"
							class="screen-reader-text"><?php esc_attr_e('Search', 'wplegalpages'); ?></label>
						<input type="search" <?php wp_nav_menu_disabled_check($nav_menu_selected_id); ?> class="quick-search"
							value="<?php echo esc_attr($searched); ?>"
							name="quick-search-posttype-<?php echo esc_attr($post_type); ?>"
					...
					<ul id="<?php echo esc_attr($post_type_name); ?>-search-checklist"
						data-wp-lists="list:<?php echo esc_attr($post_type_name); ?>" class="categorychecklist form-no-clear">
				...
				<div id="<?php echo esc_attr($post_type_name); ?>-all"
					...
					role="region" aria-label="<?php echo esc_attr($post_type_name); ?>" tabindex="0">
				...
				<p class="button-controls wp-clearfix" data-items-type="posttype-<?php echo esc_attr($post_type_name); ?>">
					...
					<span class="add-to-menu">
						<input type="submit" <?php wp_nav_menu_disabled_check($nav_menu_selected_id); ?>
							class="button submit-add-to-menu right" value="<?php esc_attr_e('Add to Menu', 'wplegalpages'); ?>"
