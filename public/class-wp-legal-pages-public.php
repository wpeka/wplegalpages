...
if ( ! class_exists( 'WP_Legal_Pages_Public' ) ) {
	...
	class WP_Legal_Pages_Public {
		...
		public function wplegal_post_generate( $content ) {
			global $post;
			if ( is_page() ) {
				$generate_text = "<div style='font-size: 0.7em;'><i>Policy generated by <a href='https://club.wpeka.com/product/wplegalpages/?utm_source=generated-page&utm_medium=credit-link' rel='nofollow' target='_blank'>WP Legal Pages</a></i></div>";
