...
if (! class_exists('WP_Legal_Pages')) {
    ...
    class WP_Legal_Pages 
    {
        ...
        private function load_dependencies() 
        {
             ...
             * core WP_Legal_Pages.
             */
            include_once plugin_dir_path(__DIR__) . 'includes/class-wp-legal-pages-loader.php';

            /**
             * The class responsible for defining internationalization functionality
             * of the WP_Legal_Pages.
             */
            include_once plugin_dir_path(__DIR__) . 'includes/class-wp-legal-pages-i18n.php';

            /**
             * The class responsible for defining all actions that occur in the admin area.
             */
            include_once plugin_dir_path(__DIR__) . 'admin/class-wp-legal-pages-admin.php';

            /**
             * The class responsible for defining all actions that occur in the public-facing
             * side of the site.
             */
            include_once plugin_dir_path(__DIR__) . 'public/class-wp-legal-pages-public.php';

            /**
             * The class responsible for defining widget specific functionality
             * of the WP_Legal_Pages.
             */
            include_once plugin_dir_path(__DIR__) . 'widgets/class-wp-widget-legal-pages.php';

            /**
             * The class responsible for defining internationalization functionality
             * of the WP_Legal_Pages.
             */
            include_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-wp-legal-app-auth.php';
            $this->library_auth = new WP_Legal_Pages_App_Auth();

            include_once plugin_dir_path(dirname(__FILE__)) . 'includes/settings/class-wp-legal-pages-api.php';
