...
class WP_Legal_Pages_Public_Test extends WP_UnitTestCase {
	...
	public function test_wplegal_post_generate() {
		...
		$generated_text = "<div style='font-size: 0.7em;'><i>" . get_the_title( get_post( $post_id ) ) . " generated by <a href='https://wplegalpages.com/legal-pages/?utm_source=generated-page&utm_medium=credit-link' rel='nofollow' target='_blank'>WPLegalPages</a></i></div>";
